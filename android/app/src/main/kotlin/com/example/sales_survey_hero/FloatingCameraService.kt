...
class FloatingCameraService : Service(), LifecycleOwner {
    ...
    private fun setupCameraWidget(layoutType: Int) {
        ...
        expandedView.addView(previewView); expandedView.addView(closeBtn); animateClick(galleryBtn); expandedView.addView(galleryBtn); animateClick(extractBtn); expandedView.addView(extractBtn); animateClick(solarBtn); expandedView.addView(solarBtn); camRoot.addView(expandedView); camRoot.addView(collapsedTab)
